...
config.General.requestName = '2018A_Jun_v1'
config.JobType.psetName = '/afs/cern.ch/work/z/zhixing/private/CMSSW_10_2_5/src/CMSDIJET/DijetRootTreeMaker/prod/flat-data-cfg_miniAOD_A.py'
